...
class SolidObjectTest {
    ...
    fun `speed of light`() {
        ...
        control.accelerate = true
        ship.tick(100.0, Transaction()) // long time
        val v = ship.velocity
        val speed = v.length
